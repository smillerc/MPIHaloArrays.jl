...
"""
function scatterglobal(A::AbstractArray{T, 1}, root::Int, nhalo::Int, topology::AbstractParallelTopology; halo_dims = (1), do_corners = true, com_model = :p2p) where {T}
...
function scatterglobal(A::AbstractArray{T, 2}, root::Int, nhalo::Int, topology::AbstractParallelTopology; halo_dims = (1,2), do_corners = true, com_model = :p2p) where {T}
